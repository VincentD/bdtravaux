...
class BdTravauxDialog(QtGui.QDialog):
    ...
    def sauverInfos(self):
        ...
        query = """insert into bdtravaux.sortie (date_sortie, redacteur, codesite, jours_chan, chantfini, chantvol, sort_com) values ('{zr_date_sortie}'::date, '{zr_redacteur}', '{zr_site}', '{zr_jours_chantier}', {zr_chantier_fini}, {zr_chantier_vol}, '{zr_sort_com}')""".format (zr_date_sortie=self.ui.date.selectedDate().toString('yyyy-MM-dd'),\
