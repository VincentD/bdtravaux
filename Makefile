...
# translation
SOURCES = bd_cen.py ui_bdtravaux.py __init__.py bdt_sortie_dialog.py bdt_operation_dialog.py bdt_composeur.py bdt_prevu_dialog.py bds_suivis_dialog.py
...
PY_FILES = bd_cen.py bdt_sortie_dialog.py __init__.py bdt_operation_dialog.py bdt_convert_geoms.py bdt_prevu_dialog.py bdt_composeur.py bdh_habnat_dialog.py bds_suivis_dialog.py
...
UI_FILES = ui_bdtravaux_sortie.py ui_operation.py ui_gestprev.py ui_bdhabnat_dialog.py ui_bdsuivis_dialog.py
