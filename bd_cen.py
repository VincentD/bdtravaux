...
class BdTravaux:
    ...
    def __init__(self, iface):
        ...
        self.plugin_dir = QtCore.QFileInfo(QgsApplication.qgisUserDbFilePath()).path() + "/python/plugins/bdcen"
        # initialize locale
        localePath = ""
...
#        self.dlg_suivis_test = bdsuivisDialog_test()
    ...
    def initGui(self):
        ...
        self.sortie = QtGui.QAction(
            QtGui.QIcon(":/plugins/bdcen/rs_icon_bdt_sort.png"),
        ...
        self.operation = QtGui.QAction(
            QtGui.QIcon(":/plugins/bdcen/rs_icon_bdt_ope.png"),
        ...
        self.prevu = QtGui.QAction(
            QtGui.QIcon(":/plugins/bdcen/rs_icon_bdt_prev.png"),
        ...
        self.habnat = QtGui.QAction(
            QtGui.QIcon(":/plugins/bdcen/rs_icon_bdh.png"),
        ...
        self.suivprev = QtGui.QAction(
            QtGui.QIcon(":/plugins/bdcen/rs_icon_bds.png"),
