...
class BdTravauxDialog(QtGui.QDialog):
    ...
    def sauverInfos(self):
        ...
        query = u'INSERT INTO bdtravaux.sortie (date_sortie, redacteur, codesite, chantvol, sortcom, objvisite) VALUES (\'{zr_date_sortie}\'::date, \'{zr_redacteur}\', \'{zr_site}\', {zr_chantier_vol}, \'{zr_sort_com}\', \'{zr_objvisite}\')'.format(\
        ...
        zr_objvisite=self.objetVisiText).encode("latin1")
        print query
